/* =====================================
Footer Content - Embedded Footer HTML
This file contains the footer HTML as a JavaScript string
                            ...
                            <div class="row">
                                <div class="col-md-8 col-sm-8">
                                    <div class="call-to-action-left p-tb20 p-r50">
                                        ...
                                        <p>Ready to experience the best massage spa services in Charlotte NC? Contact our expert massage therapists in Newell, NC today to book your therapeutic massage or full body massage session.</p>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">  
                            <div class="widget widget_about">
                                ...
                                <p>WuSpa is a boutique wellness suite engineered as a calm reset point for high-performing lives. Every maneuver every service is performed with intention to heal, loosen, uplift and reset your body into balance. The space delivers personalized massage and skincare experiences designed to quiet the noise, restore balance, and elevate everyday resilience.
                                </p>  
                            </div>
                        </div> 
                        <!-- SERVICES -->
                ...
                <div class="container p-t30">
                    <div class="row ftr-btm">
                        <div class="wt-footer-bot-left">
                            <span class="copyrights-text">© 2026 All Rights Reserved. Designed By <a href="https://dmworxllc.com/" target="_blank" rel="noopener noreferrer" class="site-text-primary">DM Worx LLC</a>.</span>
                        </div>
